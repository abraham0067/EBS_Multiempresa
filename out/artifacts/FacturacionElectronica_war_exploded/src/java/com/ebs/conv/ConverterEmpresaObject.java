 ...
 */
@FacesConverter("converterEmpresa2")
public class ConverterEmpresaObject implements Converter{
    @Override
...
//                return hl.getEmpresasAsignadas().get(index);
    ...
    public String getAsString(FacesContext context, UIComponent component, Object object) {
        if(object != null) {
            ...
            String id = String.valueOf(tmp.getId());//Usado como parametro para el metodo get as object
            return id;
        } 
