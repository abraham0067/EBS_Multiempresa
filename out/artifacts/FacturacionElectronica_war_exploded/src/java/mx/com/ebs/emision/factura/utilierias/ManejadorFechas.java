...
public class ManejadorFechas {
	...
	/**
	 * Obtiene la fecha en formado diamesa�o
	...
	/**
	 * Obtiene la fecha en formado a�o - mes - dia  hora:minuto
	 * @return String Cadena con la fecha en formato predefinido
	 * */
	...
	/**
	 * M�todo encargado de convertir una cadena con formato DATE a un objeto Date
