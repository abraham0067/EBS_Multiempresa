...
public class ManagedBeanFileUtil implements Serializable {
    ...
    public void downloadXmlCfdiFile(Integer idCfd, String nombreArchivo) {
        ...
        try {
            ...
            if (idCfd <= 0) {
                ...
                otro = facturaManejador.ObtenerMOtroPorCFDIXML(idCfd);
                if (otro != null) {
                    ...
                    archivosFactura = facturaManejador
    ...
    /**
     * Download the xml File for CFD Invoice
     *
     * @param numeroFactura
     * @param nombreFactura
     * @return
