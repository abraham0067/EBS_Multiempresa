...
public class XmlMocksProvider {
    ...
    public static String getXml1() {
        return XmlMocksProvider.xml1;
    }

    public static String getXml2() {
        return XmlMocksProvider.xml2;
    }

    public static String getXml3() {
        return XmlMocksProvider.xml3;
    }

    public static String getXml4() {
        return XmlMocksProvider.xml4;
    }

    public static String getXml5() {
        return XmlMocksProvider.xml5;
    }

    public static String getXml6() {
        return XmlMocksProvider.xml6;
    }

    public static String getXml7() {
        return XmlMocksProvider.xml7;
    }

    public static String getXml8() {
        return XmlMocksProvider.xml8;
    }

    public static String getXml9() {
        return XmlMocksProvider.xml9;
    }

    public static String getXml10() {
        return XmlMocksProvider.xml10;
    }
}
