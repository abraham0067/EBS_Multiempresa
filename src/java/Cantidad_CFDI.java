...
public class Cantidad_CFDI extends JRDefaultScriptlet {
	
	  public Cantidad_CFDI() {
    ...
    {
		Cantidad_CFDI cantidad = new Cantidad_CFDI();
    ...
    public String getCantidad(double d, String moneda)
    {
        ...
        if(moneda!=null && "USD".equals(moneda.trim())){
        	 s = (new StringBuilder()).append(s).append(num2Text((long)d)).append(" DOLARES ").append(s1).append("/100 USD)").toString();
        }else{
